...
from yarngpt.exceptions import AuthenticationError, ValidationError, APIError, YarnGPTError
...
class TestIntegration:
    ...
    def test_real_tts_request(self):
        ...
        with YarnGPT() as client:
            audio = client.text_to_speech(text="Test speech", voice=Voice.IDERA)
    ...
    def test_save_to_file(self, tmp_path):
        ...
        with YarnGPT() as client:
            result_path = client.text_to_speech_file(
                text="Test speech", output_path=output_file, voice=Voice.JUDE
            )
